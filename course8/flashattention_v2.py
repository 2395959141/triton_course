...
#     configs=[
#         triton.Config(
#             {"BLOCK_M_SIZE": 64, "BLOCK_N_SIZE": 64}, num_warps=2, num_stages=1
#         ),
#         triton.Config(
#             {"BLOCK_M_SIZE": 64, "BLOCK_N_SIZE": 64}, num_warps=4, num_stages=1
#         ),
#         triton.Config(
#             {"BLOCK_M_SIZE": 64, "BLOCK_N_SIZE": 64}, num_warps=8, num_stages=1
#         ),
#         triton.Config(
#             {"BLOCK_M_SIZE": 128, "BLOCK_N_SIZE": 64}, num_warps=2, num_stages=1
#         ),
#         triton.Config(
#             {"BLOCK_M_SIZE": 128, "BLOCK_N_SIZE": 64}, num_warps=4, num_stages=1
#         ),
#         triton.Config(
#             {"BLOCK_M_SIZE": 128, "BLOCK_N_SIZE": 64}, num_warps=8, num_stages=1
#         ),
#         triton.Config(
#             {"BLOCK_M_SIZE": 64, "BLOCK_N_SIZE": 128}, num_warps=2, num_stages=1
#         ),
#         triton.Config(
#             {"BLOCK_M_SIZE": 64, "BLOCK_N_SIZE": 128}, num_warps=4, num_stages=1
#         ),
#         triton.Config(
#             {"BLOCK_M_SIZE": 64, "BLOCK_N_SIZE": 128}, num_warps=8, num_stages=1
#         ),
#     ],
#     key=["BLOCK_DHEAD_SIZE", "heads", "num_kv_groups"],
# )
